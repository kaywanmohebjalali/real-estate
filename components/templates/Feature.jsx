...
const Feature = () => {
  return (
    <div className="container grid gap-6 grid-cols-1 small:grid-cols-2  sm:grid-cols-2  xl:grid-cols-3 mt-[52vh] sm:mt-[22vh]  xl:mt-[10vh]">

      <Box icon={<HiGlobeAlt size='2rem'  className="text-backGround-gold" />}>
      ...
      <Box icon={<HiOutlineLocationMarker  size='2rem'  className="text-backGround-gold " />}>
        <div className="w-[80%] pt-4">
      ...
      <Box icon={<HiOutlineKey   size='2rem'  className="text-backGround-gold " />}>
        <div className="w-[80%] pt-4">
      ...
      <Box icon={<HiOutlinePresentationChartLine    size='2rem'  className="text-backGround-gold" />}>
        <div className="w-[80%] pt-4">
      ...
      <Box icon={<HiOutlineLockClosed  size='2rem'  className="text-backGround-gold " />}>
        <div className="w-[80%] pt-4">
      ...
      <Box icon={<HiOutlineScale   size='2rem'  className="text-backGround-gold " />}>
        <div className="w-[80%] pt-4">
